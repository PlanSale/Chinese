	...
	ckplayer.prototype = {
		...
		*/
		embed: function(c) {
			...
			if (isThirdUrl){
				document.getElementById( this.vars['container'].substring(1)).innerHTML = "<iframe  src='"+videoString+"' style='width:100%;height:100%;min-height:200px;' frameborder=0 width='100%' height='100%' scrolling='no' allowfullscreen></iframe>";
				return;
			}
